...
.boy { color:#0066ff; }
.girl { color:#ff66ff;}
.boy, .girl, .m_ico, .a_ico, .sa_ico, .v_ico {
	font-size:20px;
	text-align:center;
	margin-left:10px;
}
...
<div id="wrap_manual">
	...
	<div class="section top_separator">
		<ul>
			...
			<li><a href="#part51">Facebook login</a></li>
			<li><a href="#part55">Draggable features</a></li>
		</ul>
		<ul>
			...
			<li><a href="#part52">Bridge what it is?</a></li>			
		</ul>
		<ul>
			...
			<li><a href="#part53">Userlist icons</a></li>
		</ul>
		<ul>
			...
			<li><a href="#part54">Upload system</a></li>
		</ul>
		<div class="clear"></div>
	</div>
	<a name="part1"></a>
	...
	<h2>Upload system</h2>
	<div class="section top_separator">
		<p>Boomchat include a upload system that allow users to upload picture directly to the chat or private chat by clicking the icon located in the imput. This system can be disabled for 
		users or setted to be available only for staff and admin. The upload system also include a build in cleaning tool that will keep your server clean and will delete files uploaded by users
		after the time you will have choose in your setting panel.</p>
	</div>
	
	<a name="part51"></a>
	<h2>Facebook login</h2>
	<div class="section top_separator">
		<p>In your setting panel you can activate or not the facebook login option by activating this option you will allow users to login with their facebook account to boomchat.
		To activate the facebook login you will first have to create your facebook app. Once your facebook app created you have to put your app id and app secret into boomchat setting panel in the
		registration tab options. Note that the index path in settings must be setted properly and facebook login will not work if not. If you are not sure how to create a facebook app please refer to youtube you 
		will find plenty of video showing you how to achieve it.</p>
	</div>
	
	<a name="part55"></a>
	<h2>Draggable features</h2>
	<div class="section top_separator">
		<p>From boomchat 7.0 many feature can now be dragged or resized to allow user to move them in browser window. The private chat window is draggable and the emoticon is also draggable. You will also find a new lock icon in
		the emoticon panel. By clicking the lock icon it will make the emoticon window stay open and not close when selecting emoticon.</p>
	</div>
	
	<a name="part53"></a>
	<h2>Userlist icons</h2>
	<div class="section top_separator">
		<p>New from boomchat 7.0 the icon in the userlist are indicating the rank of special user and also the gender of users if they have fill up gender in their profile.</p>
		<table>
			<tr><td><i class="v_ico fa fa-plus"></i></td><td class="description">Vip</td></tr>
			<tr><td><i class="m_ico fa fa-shield"></td></i><td class="description">Moderator</td></tr>
			<tr><td><i class="a_ico fa fa-star"></i></td><td class="description">Admin</td></tr>
			<tr><td><i class="sa_ico fa fa-star"></i></td><td class="description">Superadmin</td></tr>
			<tr><td><i class="fa fa-mars boy"></i></td><td class="description">Male</td></tr>
			<tr><td><i class="fa fa-venus girl"></i></td><td class="description">female</td></tr>
		</table>
	</div>
	...
	<h2>Bridge system</h2>
	<div class="section top_separator">
		<p>New from boomchat 7.0 the bridge system give to boomchat a brand new way to connect users to other system like wordpress, joomla , dupral or any kind of system. Lets say you have
		a wordpress site and want to use your current users to log automaticly to boomchat if they are logged to your wordpress site then you will need to install the boomchat wordpress bridge that is available
		on Code Canyon. Each bridge module are different and you will need to install the module that is required by your system. If the module for your system is not available yet please contact
		Boomchat support and lets him know. If you are interested to know more about how the bridge module work and want to buid your own module for the bridge you can contact boomchat support. NOte that once a module installed
		lets take wordpress for example the first administrator from wordpress to connect to the chat using the bridge button will become superadmin. All future administrator from wordpress will become admin. The bridge can
		be different from system. Please before buying a bridge module be sure the bridge will fit your current sytem.</p>
		<h3>Only bridge mode</h3>
		<p>This bridge option will convert your actual login form to a bridge form that will contain only <span class="note"> Login with site </span> button and of course login facebook and guest if you have selected to use them.
	</p>
		<h3>Add bridge mode</h3>
		<p>In this mode the bride button <span class="note"> Login with site </span> is added to your current login form</p>
	</div>
	...
	<div class="section top_separator">
		...
		<table>
			<tr><td class="title">Use bridge registration</td><td class="description"> Turn on bridge registration <span class="note"> Bridge required</span></td></tr>
			...
			<tr><td class="title">Use facebook login</td><td class="description"> This option will turn on/off the facebook login button. note that you must insert valid id and secret that you will create from your facebook account</td></tr>
			<tr><td class="title">Facebook app id</td><td class="description"> Here you input your facebook app id</td></tr>
			<tr><td class="title">Facebook app secret</td><td class="description"> Here you insert your facebook app secret.</td></tr>
		...
		<table>
			...
			<tr><td class="title">Delete upload files delay</td><td class="description">Set the delay before the build in system delete uploaded images</td></tr>
		</table>
