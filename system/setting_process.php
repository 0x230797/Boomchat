...
require_once("config.php");
	...
	if(isset($_POST['site_title'])
		...
		$setico = $mysqli->real_escape_string(trim($_POST['set_ico']));
		$setht = $mysqli->real_escape_string(trim($_POST['set_ht']));
		...
		if($setht == ''){$setht = $mysqli->real_escape_string(trim($setting['ht']));}
