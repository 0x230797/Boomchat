...
?>
			...
			<div class="top_separator" id="container_setting">
				<div class="setting_part load_part" id="setting_site">
					...
					<div class="setting_message_zone bottom_separator top_separator">
							<label>Home title</label><br />
							<input id="set_ht" placeholder="<?php echo $htitle; ?>" class="news_title_zone"/>
							<div class="clear"></div>
					</div>
					<div class="setting_message_zone bottom_separator top_separator">
				...
				<div class="setting_part" id="setting_user">
					...
					<div class="option_setting bottom_separator">
						<div class="option_left">
							<label>Display rank & gender icon</label>
							<select id="set_list_ico">
								<option value="1" <?= $uselistico == 1 ? 'selected="selected"' : '' ?>><?php echo $syes; ?></option>
								<option value="0" <?= $uselistico == 0 ? 'selected="selected"' : '' ?>><?php echo $sno; ?></option>
							</select>
						</div>
						<div class="clear"></div>
					</div>
